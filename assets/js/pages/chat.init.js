...
(function () {
    var dummyUserImage = (window.baseUrl || '') + "assets/images/users/user-dummy-img.jpg";
    var dummyMultiUserImage = (window.baseUrl || '') + "assets/images/users/multi-user.jpg";
    ...
    var url = (window.baseUrl || '') + "assets/json/";
    var usersList = "";
    var userChatId = 1;
    ...
    // Wait for app to be ready before initializing chat
