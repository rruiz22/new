    ...
    if (vectorMapWorldMarkersColors) {
        ...
        worldemapmarkers = new jsVectorMap({
            ...
            markers: [{
                ...
                style: {
                    image: (window.baseUrl || '') + "assets/images/flags/us.svg",
                }
            },
            {
                name: "Russia",
                ...
                style: {
                    image: (window.baseUrl || '') + "assets/images/flags/russia.svg",
                }
            },
            {
                name: "Spain",
                ...
                style: {
                    image: (window.baseUrl || '') + "assets/images/flags/spain.svg",
                }
            },
            {
                name: "Italy",
                ...
                style: {
                    image: (window.baseUrl || '') + "assets/images/flags/italy.svg",
                }
            },
            {
                name: "Germany",
                ...
                style: {
                    image: (window.baseUrl || '') + "assets/images/flags/germany.svg",
                }
            },
            ],
            markerStyle: {
