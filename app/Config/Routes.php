...
// Vehicles module routes are now loaded via Events.php
...
// Vehicles module routes (load manually for now)
$vehiclesRoutes = APPPATH . 'Modules/Vehicles/Config/Routes.php';
if (file_exists($vehiclesRoutes)) {
    $routesLoader = include $vehiclesRoutes;
    if (is_callable($routesLoader)) {
        $routesLoader($routes);
    }
}
