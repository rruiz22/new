...
waitForDataTablesOnPending(function() {
            ...
            pendingOrdersTable = $('#pending-orders-table').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'status',
                        render: function(data, type, row) {
                            // Handle undefined/null status data
                            if (!data || typeof data !== 'string') {
                                data = 'pending'; // Default to pending if status is missing
                            }
    ...
    // Setup action button event handlers using document delegation (outside drawCallback to avoid jQuery guid errors)
    $(document).off('click.pendingTable', '#pending-orders-table .btn-view').on('click.pendingTable', '#pending-orders-table .btn-view', function(e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $(document).off('click.pendingTable', '#pending-orders-table .btn-edit').on('click.pendingTable', '#pending-orders-table .btn-edit', function(e) {
        e.preventDefault();
        e.stopPropagation();
        const orderId = $(this).data('id');
    ...
    $(document).off('click.pendingTable', '#pending-orders-table .btn-delete').on('click.pendingTable', '#pending-orders-table .btn-delete', function(e) {
        e.preventDefault();
        e.stopPropagation();
        const orderId = $(this).data('id');
    ...
    $(document).off('click.pendingTable', '#pending-orders-table tbody tr').on('click.pendingTable', '#pending-orders-table tbody tr', function(e) {
