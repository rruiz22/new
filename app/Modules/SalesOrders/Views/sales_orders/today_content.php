        ...
        try {
            ...
            todayOrdersTable = $('#today-orders-table').DataTable({
                ...
                drawCallback: function(settings) {
                    ...
                    $('#today-orders-table .btn-view').off('click.todayTable').on('click.todayTable', function(e) {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    $('#today-orders-table .btn-edit').off('click.todayTable').on('click.todayTable', function(e) {
                        e.preventDefault();
                        e.stopPropagation();
                        const orderId = $(this).data('id');
                    ...
                    $('#today-orders-table .btn-delete').off('click.todayTable').on('click.todayTable', function(e) {
                        e.preventDefault();
                        e.stopPropagation();
                        const orderId = $(this).data('id');
...
function showToast(type, message) {
    ...
    setTimeout(() => {
        if (typeof EnhancedTableIndicators !== 'undefined') {
            ...
            console.log('✨ Enhanced table indicators initialized for today orders');
        }
    }, 1000);
