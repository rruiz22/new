...
class Module
{
     ...
     * Module name
     */
    public static string $name = 'SalesOrders';
     ...
     * Module description
     */
    public static string $description = 'Sales Orders Management Module';
    ...
    public static function init()
    {
        ...
        if (is_array($viewPaths)) {
            $viewPaths[] = APPPATH . 'Modules/SalesOrders/Views/';
        } else {
            $viewPaths = [
                $viewPaths,
                APPPATH . 'Modules/SalesOrders/Views/'
            ];
        }
    ...
    {
        return APPPATH . 'Modules/SalesOrders/Views/';
    }
