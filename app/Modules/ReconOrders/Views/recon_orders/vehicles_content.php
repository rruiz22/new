...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeTables() {
        ...
        window.inventoryTable = $('#inventoryTable').DataTable({
            ...
            order: [[2, 'asc']], // Sort by days in this step (ascending - least days first)
            pageLength: 25,
    ...
    function updateInventoryStatusColumns() {
        ...
        statusElements.each(function() {
            ...
            if (stockNumber && window.orderInfoLookup && window.orderInfoLookup[stockNumber]) {
                ...
                html += `<span class="badge bg-${statusColor} px-2 py-1 fw-bold" style="font-size: 0.65rem; letter-spacing: 0.5px;">${statusLabel}</span>`;
