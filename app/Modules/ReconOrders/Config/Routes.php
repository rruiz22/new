...
return function (RouteCollection $routes) {
    ...
    $routes->group('recon_orders', ['namespace' => 'Modules\ReconOrders\Controllers', 'filter' => 'sessionauth'], function($routes) {
        ...
        // Notes endpoints - DISABLED (methods don't exist, using comments system instead)
        ...
        // Services routes - REMOVED DUPLICATES (use ReconServicesController instead)
        // Legacy routes for backward compatibility (if needed, redirect to ReconServicesController)
        $routes->get('services/view/(:num)', 'ReconOrdersController::servicesView/$1'); // TODO: Keep only if needed for order context
        $routes->get('services/show/(:num)', 'ReconOrdersController::servicesShow/$1');  // TODO: Keep only if needed for order context
        ...
        // Services management - ORDER CONTEXT ONLY (for selecting services in orders)
        ...
        // ===== SERVICES MANAGEMENT (ReconServicesController) =====
        ...
        $routes->get('services/active', 'ReconServicesController::getActiveServices');
        
        // Vehicles routes - CLEANED UP (removed non-existent methods)
        // $routes->get('vehicles', 'ReconOrdersController::vehicles'); // Method doesn't exist
        // $routes->get('vehicles/view/(:num)', 'ReconOrdersController::vehicleView/$1'); // Method doesn't exist
        // $routes->get('vehicles/search', 'ReconOrdersController::vehicleSearch'); // Method doesn't exist
        // $routes->post('vehicles/data', 'ReconOrdersController::getVehiclesData'); // Method doesn't exist
        // $routes->get('vehicles/stats', 'ReconOrdersController::getVehicleStats'); // Method doesn't exist
        $routes->get('vehicles_stats', 'ReconOrdersController::vehicles_stats'); // This method exists
