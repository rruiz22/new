...
<?= $this->section('page_title') ?>App.create_client<?= $this->endSection() ?>

<?= $this->section('page_title_main') ?>App.create_client<?= $this->endSection() ?>
                        ...
                        <div class="col-xxl-9">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= base_url('clients/store') ?>" method="post" class="needs-validation" novalidate>
                                        <?= csrf_field() ?>
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control rounded-0" id="name" name="name" value="<?= old('name') ?>" required>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea class="form-control rounded-0" id="address" name="address" rows="3"><?= old('address') ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="url" class="form-control rounded-0" id="website" name="website" value="<?= old('website') ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control rounded-0" id="tax_number" name="tax_number" value="<?= old('tax_number') ?>">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                                <label for="client_status" class="form-label"><?= lang('App.active_status') ?></label>
                                            </div>
                                            <div class="col-lg-9">
                                                <div class="position-relative">
                                                    <select class="form-select rounded-0 bg-light border-0" id="client_status" name="status" style="height: 40px; width: 100%; appearance: none; padding-right: 30px;">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-12">
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="<?= base_url('clients') ?>" class="btn btn-light"><?= lang('App.cancel') ?></a>
