...
<?= $this->section('page_title') ?>App.edit_staff<?= $this->endSection() ?>

<?= $this->section('page_title_main') ?>App.edit_staff<?= $this->endSection() ?>
                        ...
                        <div class="col-xxl-9">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><?= lang('App.edit_staff') ?></h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="<?= base_url('staff/update/' . $user->id) ?>" method="post" class="needs-validation" novalidate>
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <small class="text-muted"><?= lang('App.username_cannot_be_changed') ?></small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="password" class="form-control" id="password" name="password" placeholder="<?= lang('App.leave_empty_to_keep_current') ?>">
                                                <small class="text-muted"><?= lang('App.leave_empty_to_keep_current') ?></small>
                                            </div>
                                        </div>
                                        
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                                <label for="password_confirm" class="form-label"><?= lang('App.password_confirm') ?></label>
                                            </div>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-lg-3">
                                                <label for="staff_active_edit" class="form-label"><?= lang('App.status') ?></label>
                                            </div>
                                            <div class="col-lg-9">
                                                <div class="position-relative">
                                                    <div class="form-check form-switch form-switch-md">
                                                        <input class="form-check-input" type="checkbox" id="staff_active_edit" name="active" value="1" <?= old('active', $user->active) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="staff_active_edit"><?= lang('App.active') ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
